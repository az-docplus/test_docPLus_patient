...
const ConditionItem = ({ data, handleEdit,handleDelete, medId }) => {
  ...
  // return data.map((item) => {
    const { _id, condition, medicines, description, reports, time, addedBy, date } = data;
    console.log(reports, ":::::::::::::::::::::::")
    return (
      <>
        <Popconfirm
